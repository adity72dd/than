...
TOKEN = '7544620080:AAEJicPM7TCWZw4FIpSuYTfTR2kjA09oLLA'
MONGO_URI = 'mongodb+srv://Dangerboyop:FJgjOtOZ2z8kUptY@dangerboyop.nyzgq.mongodb.net/'
FORWARD_CHANNEL_ID = -1002386595960
CHANNEL_ID = -1002386595960
error_channel_id = -1002386595960
...
blocked_ports = [8700, 20000, 443, 17500, 9031, 20002, 2000]  # Blocked ports list
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Please contact the owner for assistance: @PATHAN_STORE_X.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
